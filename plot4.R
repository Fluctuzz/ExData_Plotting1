...
#Adjust graphing parameters to 4 plots 
par(mfrow=c(2,2))
...
## Second Plot
#Create blank plot with annotations 
with(powerconsumption, plot(DateTime,Voltage, type="n", xlab="datetime"))
#Add lines/data to the plot 
...
## Fourth Plot
#Create blank plot with annotations 
with(powerconsumption, plot(DateTime,Global_reactive_power, type="n", xlab="datetime"))
#Add lines/data to the plot 
